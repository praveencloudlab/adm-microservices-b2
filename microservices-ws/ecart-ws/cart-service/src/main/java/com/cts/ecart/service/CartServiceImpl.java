...
public class CartServiceImpl implements CartService {
	...
	public Product findProduct(int productId) {
		return restTemplate.getForObject("http://localhost:8081/api/products/" + productId, Product.class);
	}

	@Override
	public double getPrice(int productId) {
		Double price = restTemplate.getForObject("http://localhost:8082/api/price/product/" + productId, double.class);
